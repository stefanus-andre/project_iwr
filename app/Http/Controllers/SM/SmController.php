...
class SmController extends Controller
{
    public function Dashboard() {
        return view("sm.dashboard.sm_dashboard");
    }
    ...
    public function LihatDataIWR() {
        ...
        ->get();
        return view("sm.iwr.lihat_data_iwr", compact('dataIWR'));
    }

    public function AddDataIwr() {
        return view("sm.iwr.add_data_iwr");
    }
    ...
    public function SubmitAddDataIwr(Request $request) {
        try {
            ...
            return redirect()->to('/sm/lihat_data_iwr')->with('success', 'Data berhasil disimpan');
        } catch (\Exception $e) {
    ...
    public function EditDataIwr($id)
    {
        ...
        if ($iwr) {
            return view('sm.iwr.edit_data_iwr', compact('iwr'));
        } else {
    ...
    if ($iwr) {
        ...
        return redirect()->to('/sm/lihat_data_iwr')->with('success', 'Data berhasil Terupdate');
    } else {
        return redirect()->back()->with('error', 'Data not found.');
    }
}
