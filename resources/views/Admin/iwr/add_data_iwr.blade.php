...
@media (max-width: 800px) {
  ...
  <body>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{ url('/admin/submit_add_data_iwr') }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                  <div class="col">
                                      <div class="row">
                                          ...
                                          <div class="mb-3">
                                            <label>WR. No</label>
                                            <input class="form-control" type="text" id="wr_no" name="wr_no" readonly>
                                        </div>
                                          </div>
                                          <div class="col-sm-4">
                                              <div class="mb-3">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <select class="form-control" id="nama_resto" name="nama_resto"></select>
                                        </div>
                                          </div>
                                          <div class="col-sm-4">
                                              <div class="mb-3">
                                                  <label>Lokasi Resto</label>
                                                  <textarea class="form-control" name="lokasi_resto" rows="3"></textarea>
                                              </div>
                                          </div>
                                          <div class="col-sm-4">
                                              <div class="mb-3">
                              ...
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          ...
                                          <textarea class="form-control" name="permintaan_sparepart" rows="3"></textarea>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col">
                                      <div class="mb-3">
                                          ...
                                          <textarea class="form-control" name="permintaan_barang" rows="3"></textarea>
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-sm-4">
                                      <div class="mb-3">
                                          ...
                                          <input class="form-control" type="text" id="jumlah_permintaan_wcs" name="jumlah_permintaan_wcs" placeholder="Kelipatan 10">
                                      </div>
                                  </div>
                              </div>
                              <div class="row">
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <div class="mb-3 m-t-15 custom-radio-ml">
                                              <div class="form-check radio radio-primary">
                                                  <input class="form-check-input" id="radio11" type="radio" name="status_pengajuan" value="Done">
                                                  <label class="form-check-label" for="radio11">Done</label>
                                              </div>
                                              <div class="form-check radio radio-warning">
                                                  <input class="form-check-input" id="radio44" type="radio" name="status_pengajuan" value="Fail">
                                                  <label class="form-check-label" for="radio44">Fail</label>
                                              </div>
                                              <div class="form-check radio radio-danger">
                                                  <input class="form-check-input" id="radio66" type="radio" name="status_pengajuan" value="Cancel" checked>
    ...
    $(document).ready(function () {
      ...
      //generate WR
        $.ajax({
            url: '/admin/generate-wr-no',
            type: 'GET',
            dataType: 'json',
            success: function (response) {
                $('#wr_no').val(response.wr_no);
            },
            error: function () {
                console.error('Failed to fetch WR No.');
            }
        });
    });
  </script>
...
<script>
    $(document).ready(function () {
        ...
        $('#nama_resto').on('select2:open', function () {
            $(this).select2('open'); 
        });
    });
</script>
...
<script>
    $(document).ready(function () {
        $('#jumlah_permintaan_wcs').on('input', function () {
